    ...
    <section class="breadcrumb-outer text-center">
        <div class="container">
            <div class="breadcrumb-content">
                <h2 class="white">Gunung Bromo - Ijen</h2>
            ...
            <div class="row">
                <div id="content" class="col-md-8">
                    <div class="destination-content">
                        <h2 class="mar-bottom-5"><a href="{{route('bromo')}}">Trip Gunung Bromo - Kawah Ijen</a></h2>
                        ...
                        <div class="description-content">
                            ...
                            <div class="itinerary mar-bottom-30">
                                ...
                                <div class="itinerary-item">
                                    <button type="button" class="btn btn-info" data-target="#it2"><i
                                            class="fa fa-angle-double-right" aria-hidden="true"></i></button>
                                    <p class="mar-bottom-0"><span>5. </span> Kawah Ijen </p>
                                    <div id="it2" class="collapse itinerary-para">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                                        sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                                        minim veniam,
                                ...
                                <div class="itinerary-item">
                                    <button type="button" class="btn btn-info" data-target="#it2"><i
                                            class="fa fa-angle-double-right" aria-hidden="true"></i></button>
                                    <p class="mar-bottom-0"><span>6. </span> Hutan Mati </p>
                                    <div id="it2" class="collapse itinerary-para">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                                        sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                                        minim veniam,
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <ul>
                                            ...
                                            <li><i class="fa fa-check"></i> Tiket masuk lokal wisata kawah ijen</li>
