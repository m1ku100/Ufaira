...
@section('content')
    <div id="app">
        @can('create', \App\Models\Profile\Banner::class)
            <div class="card">
                <div class="card-body">
                    @include('page.back.master.gallery.gallery_form')
                </div>
            </div>
        @endcan
...
@push('js')
    ...
    <script>
        $('#form-add-banner').submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('profile.gallery.simpan') }}",
    ...
    <script>
        function getBanner() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('profile.gallery.get.data') }}",
                contentType: false,
                processData: false,
                success: function (response) {
    ...
    <script>
        function hapus(data) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('profile.gallery.hapus') }}",
                data: {
                    uuid_gallery: nama,
                },
                beforeSend: function () {
