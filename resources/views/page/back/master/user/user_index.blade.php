    ...
    <div class="card" hidden>
        ...
        <div class="card-header border-bottom">
            ...
            <div class="card-header-action">
                <a data-collapse="#filter-card-body" class="btn btn-icon btn-info" href="#">
                    <i class="fas fa-minus"></i>
                </a>
            </div>
        </div>
        <div class="collapse show" id="filter-card-body">
            <div class="card-body pb-0">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <x-select id="status" name="status" :options="$status_options"></x-select>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <x-select id="jenis_kelamin" name="jenis_kelamin" :options="$jenis_kelamin_options"></x-select>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <select style="width: 100%" name="filter-distributor" id="filter-distributor"></select>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <button style="display: block" class="w-100 btn btn-primary">Tampilkan</button>
                        </div>
                    </div>
                </div>
            </div>
...
@push('misc')
    <x-modal id="form-modal" size="xl" title="Pengguna">
        @include('page.back.master.user.user_form')
...
@push('js')
    <script>
        ...
        function before_simpan(e) {
            ...
            $.post('{{ route('master.pengguna.simpan') }}', form_data)
                .done(function (response) {
                    if (response.success) {
                        Swal.fire({
                            icon: 'success',
