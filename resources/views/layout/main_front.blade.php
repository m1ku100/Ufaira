            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="slide-inner">
                        <div class="slide-image" style="background-image:url({{asset('front/images/slider/bromo.jpg')}})"></div>
                ...
                <div class="swiper-slide">
                    <div class="slide-inner">
                        <div class="slide-image" style="background-image:url({{asset('front/images/slider/bromo2.jpg')}})"></div>
                        <div class="swiper-content">
                ...
                <div class="swiper-slide">
                    <div class="slide-inner">
                        <div class="slide-image" style="background-image:url({{asset('front/images/slider/ijen.jpg')}})"></div>
                        <div class="swiper-content">
                ...
                <div class="swiper-slide">
                    <div class="slide-inner">
                        <div class="slide-image" style="background-image:url({{asset('front/images/slider/ijen2.jpg')}})"></div>
                        <div class="swiper-content">
                            <h1>Your <span>Adventure</span> Wonderful Travel Calls Fast</h1>
                            <p class="mar-bottom-20">Find awesome hotel, tour, car and activities in London to ensue and equal fail in their duty</p>
                            <a href="" class="biz-btn">View More</a>
